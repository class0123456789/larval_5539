        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="row">
                                ...
                                <div class="content">
                                    ...
                                    @foreach($messages as $message)
                                        ...
                                        <div class="{{Auth::user()->id == $message->user_id ? 'chat-right' : 'chat-left'}}">
                                            <img src="{{ $message->user_avatar ? $message->user_avatar: '/'.config('room.default_avatar')}}" alt=""
                    ...
                    {{--room end--}}
                    <span class="default-value hide" data-default-avatar="{{ Auth::user()->avatar ? Auth::user()->avatar :'/'.config('room.default_avatar')}}"
