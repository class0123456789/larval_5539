    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form method="post" action="{{url('admin/devicemodel')}}" onsubmit="return validate()" class="form-horizontal">
            {{csrf_field()}}
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              <label class="col-sm-2 control-label">设备型号</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="name" value="{{old('name')}}" placeholder="设备型号">
                @if ($errors->has('name'))
              ...
              <div class="form-group{{ $errors->has('hardconfig') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-10">
                      <input type="text" class="form-control" name="hardconfig" value="{{old('hardconfig')}}" placeholder="硬件配置简介">
            ...
            <div class="form-group{{ $errors->has('brand_id') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                  <select name="brand_id" class="form-control" id="brand_id">
                      {!!$devicemodelPresenter->topBrandList($brands) !!}
                  </select>
            ...
            <div class="form-group">
              <div class="col-sm-4 col-sm-offset-2">
                  ...
                  @endif
                  @if(haspermission('devicemodel.store'))
