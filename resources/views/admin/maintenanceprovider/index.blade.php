...
<div class="row wrapper border-bottom white-bg page-heading">
  ...
  <div class="col-lg-2">
    <div class="title-action">
      @if(haspermission('maintenanceprovider.create'))
      <a href="{{url('admin/maintenanceprovider/create')}}" class="btn btn-info">增加维保厂商</a>
      @endif
    </div>
  </div>
 ...
 <script type="text/javascript">
     ...
     // "orderCellsTop": true,
      "dom" : '<"html5buttons"B>lTfgtip',
                    "buttons": [
        {extend: 'copy',title: 'maintenanceprovider'},
        {extend: 'csv',title: 'maintenanceprovider'},
        {extend: 'excel', title: 'maintenanceprovider'},
                    ...
                    columnDefs: [
                        {
                            ...
                            var row_show = {{haspermission('maintenanceprovider.show')? 1 : 0}};
                            var row_edit = {{haspermission('maintenanceprovider.edit')? 1 : 0}};
                            var row_delete = {{haspermission('maintenanceprovider.destroy') ? 1 :0}};
                            var str = '';
