...
<div class="row wrapper border-bottom white-bg page-heading">
  ...
  <div class="col-lg-2">
    <div class="title-action">
      @if(haspermission('devicesavestate.create'))
      <a href="{{url('admin/devicesavestate/create')}}" class="btn btn-info">增加设备保管状态</a>
      @endif
    </div>
  </div>
                    ...
                    columnDefs: [
                        {
                            ...
                            //var row_show = {{haspermission('devicesavestate.show')? 1 : 0}};    
                            var row_edit = {{haspermission('devicesavestate.edit')? 1 : 0}};
                            var row_delete = {{haspermission('devicesavestate.destroy') ? 1 :0}};
                            var str = '';
                            ...
                            if (row_edit && row['id']!=1) {//id为1不能编
                                //str += '<a style="margin:3px;" href="/admin/permission/' + row['id'] + '/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
                                str +='<a href="/admin/devicesavestate/'+row['id']+'/edit" class="btn btn-xs btn-outline btn-warning tooltips" data-original-title="编辑" data-placement="top"><i class="fa fa-edit"></i></a>';
                            }
