...
<div class="row wrapper border-bottom white-bg page-heading">
  ...
  <div class="col-lg-2">
    <div class="title-action">
      ...
      <a href="{{url('admin/brand/create')}}" class="btn btn-info">增加品牌</a>
      @endif
    </div>
  </div>
 ...
 <script type="text/javascript">
     ...
     // "orderCellsTop": true,
      "dom" : '<"html5buttons"B>lTfgtip',
                    "buttons": [
        {extend: 'copy',title: 'brand'},
        {extend: 'csv',title: 'brand'},
        {extend: 'excel', title: 'brand'},
                    ...
                    columnDefs: [
                        {
                            ...
                            var row_show = {{haspermission('brand.show')? 1 : 0}};
                            var row_edit = {{haspermission('brand.edit')? 1 : 0}};
                            var row_delete = {{haspermission('brand.destroy') ? 1 :0}};
                            var str = '';
                            ...
                            if (row_show) {
                                ...
                                str +='<a href="/admin/brand/'+row['id']+'" class="btn btn-xs btn-info tooltips" data-toggle="modal" data-target="#myModal"  data-original-title="查看" data-placement="top"><i class="fa fa-eye"></i></a>';
                            }

                            //编辑
                            if (row_edit) {
                                //str += '<a style="margin:3px;" href="/admin/permission/' + row['id'] + '/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
                                str +='<a href="/admin/brand/'+row['id']+'/edit" class="btn btn-xs btn-outline btn-warning tooltips" data-original-title="编辑" data-placement="top"><i class="fa fa-edit"></i></a>';
                            }
