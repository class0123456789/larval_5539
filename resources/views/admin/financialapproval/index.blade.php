...
<div class="row wrapper border-bottom white-bg page-heading">
  ...
  <div class="col-lg-2">
    <div class="title-action">
      @if(haspermission('financialapproval.create'))
      <a href="{{url('admin/financialapproval/create')}}" class="btn btn-info">增加购置批文</a>
      @endif
    </div>
  </div>
