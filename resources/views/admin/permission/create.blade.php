        ...
        <div class="ibox-content">
          ...
          <form method="post" action="{{route('permission.store')}}" class="form-horizontal">
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="name" value="{{old('name')}}" placeholder="权限名称"> 
                @if ($errors->has('name'))
            ...
            <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="slug" value="{{old('slug')}}" placeholder="权限规则"> 
                @if ($errors->has('slug'))
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="description" value="{{old('description')}}" placeholder="权限描述">
              </div>
            </div>
            <!--<div class="hr-line-dashed"></div>
            <div class="form-group">
                 ...
                 <div class="col-sm-10">
                    <div class="i-checks">
                        ...
                        <label> <input type="radio" name='cid' value="-1" checked=""><i></i>非菜单项</label>
                    </div>
                </div>
            </div>-->
            <!--<div class="hr-line-dashed"></div>
