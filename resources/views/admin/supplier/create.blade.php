    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form method="post" action="{{url('admin/supplier')}}" class="form-horizontal">
            {{csrf_field()}}
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              <label class="col-sm-2 control-label">供应商名称</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="name" value="{{old('name')}}" placeholder="供应商名称">
                @if ($errors->has('name'))
            ...
            <div class="form-group">
              <div class="col-sm-4 col-sm-offset-2">
                  ...
                  @endif
                  @if(haspermission('supplier.store'))
