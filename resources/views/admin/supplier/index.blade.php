...
<div class="row wrapper border-bottom white-bg page-heading">
  ...
  <div class="col-lg-2">
    <div class="title-action">
      ...
      <a href="{{url('admin/supplier/create')}}" class="btn btn-info">增加供应商</a>
      @endif
    </div>
  </div>
 ...
 <script type="text/javascript">
     ...
     // "orderCellsTop": true,
      "dom" : '<"html5buttons"B>lTfgtip',
                    "buttons": [
        {extend: 'copy',title: 'supplier'},
        {extend: 'csv',title: 'supplier'},
                    ...
                    columnDefs: [
                        {
                            ...
                            var row_show = {{haspermission('supplier.show')? 1 : 0}};
                            var row_edit = {{haspermission('supplier.edit')? 1 : 0}};
                            var row_delete = {{haspermission('supplier.destroy') ? 1 :0}};
                            var str = '';
