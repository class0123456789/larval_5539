...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-6">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            @if(haspermission('houseinstitution.index'))
            <a href="/admin/houseinstitution"><strong>机构设备列表</strong></a>
            @endif
        </li>
    </ol>
  </div>
   @if(haspermission('houseinstitution.create'))
  <div class="col-lg-1">
    <div class="title-action">
      <a href="{{url('admin/houseinstitution/create')}}" class="btn btn-w-m btn-info ">设备入库</a>
    </div>
  </div>
  @endif
    @if(haspermission('admin/houseinstitution/supplement'))
        <div class="col-lg-1">
            <div class="title-action">
                <a href="{{url('admin/houseinstitution/supplement')}}" class="btn btn-w-m btn-warning">设备补录</a>
            </div>
        </div>
    @endif
    <div class="col-lg-1">
        <div class="title-action">
            <a href="{{url('admin/houseinstitution/applytouse')}}" class="btn btn-w-m btn-success">设备申领</a>
        </div>
    </div>
    <div class="col-lg-1">
        <div class="title-action">
            <a href="{{url('admin/houseinstitution/applicationreview')}}" class="btn btn-w-m btn-danger">申领审核</a>
        </div>
    </div>
    <div class="col-lg-1">
        <div class="title-action">
            <a href="{{url('admin/houseinstitution/redeployment')}}" class="btn btn-w-m btn-primary">设备调出</a>
        </div>
    </div>
</div>
...
<script type="text/javascript">
  ...
  $(document).on('click','.reset_password',function() {
    ...
    layer.confirm('重置', {
      ...
      $.ajax({
        url:'/admin/houseinstitution/'+_id+'/reset',
                    ...
                    columnDefs: [
                        {
                            ...
                            var row_show = {{haspermission('houseinstitution.show')? 1 : 0}};
                            var row_edit = {{haspermission('houseinstitution.edit')? 1 : 0}};
                            var row_delete = {{haspermission('houseinstitution.destroy') ? 1 :0}};
                            var str = '';
                            ...
                            if (row_show) {
                                ...
                                str +='<a href="/admin/houseinstitution/'+row['id']+'" class="btn btn-xs btn-info tooltips"  data-original-title="查看" data-placement="top"><i class="fa fa-eye"></i></a>';
                            }
                            ...
                            if (row_edit) {
                                //if(row['id']!=1){
                                //str += '<a style="margin:3px;" href="/admin/permission/' + row['id'] + '/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
                                str +='<a href="/admin/houseinstitution/'+row['id']+'/edit" class="btn btn-xs btn-outline btn-warning tooltips" data-original-title="编辑" data-placement="top"><i class="fa fa-edit"></i></a>';
                                //}else{
                                //   str +=''; 
                                //}
