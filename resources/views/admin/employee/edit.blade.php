        ...
        <div class="ibox-content">
          <form method="post" action="{{url('admin/employee/'.$employee->id)}}" class="form-horizontal">
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="name" value="{{old('name',$employee->name)}}" placeholder="员工名称"> 
                @if ($errors->has('name'))
            ...
            <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="mobile" value="{{old('mobile',$employee->mobile)}}" placeholder="手机号码"> 
              ...
              <div class="form-group{{ $errors->has('sfz') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-10">
                      <input type="text" class="form-control" name="sfz" value="{{old('sfz',$employee->sfz)}}" placeholder="身份证号">
                      @if ($errors->has('sfz'))
            ...
            <div class="form-group{{ $errors->has('sex') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                {!!$employeePresenter->sexList($employee->sex)!!}
                @if ($errors->has('sex'))
            ...
            <div class="form-group{{ $errors->has('post') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="post" value="{{old('post',$employee->post)}}" placeholder="员工岗位"> 
                @if ($errors->has('post'))
            ...
            <div class="form-group{{ $errors->has('institution_id') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <select name="institution_id" class="form-control">
                      {!!$employeePresenter->topInstitutionList($institutions,$employee->institution->id) !!}
                 </select>
              </div>
            </div> 
