 ...
 <script type="text/javascript">
     ...
     // "orderCellsTop": true,
      "dom" : '<"html5buttons"B>lTfgtip',
                    "buttons": [
        {extend: 'copy',title:'员工表',exportOptions:{
            columns:[0,2,3,4,5,6],//选择打印列
        }},
        {extend: 'csv',title:'员工表',exportOptions:{
            columns:[0,2,3,4,5,6],//选择打印列
        }},
        {extend: 'excel', title:'员工表',exportOptions:{
            columns:[0,2,3,4,5,6],//选择打印列
        }},
        //{extend: 'pdf', title: 'permission'},
        {extend: 'print',title:'员工表',exportOptions:{
            columns:[0,2,3,4,5,6],//选择打印列
        }}
        ],
                    "columns": [
                    ...
                    columnDefs: [
                        {
                            ...
                            //var row_show = {{haspermission('employee.show')? 1 : 0}};    
                            var row_edit = {{haspermission('employee.edit')? 1 : 0}};
                            var row_delete = {{haspermission('employee.destroy') ? 1 :0}};
                            var str = '';
                            ...
                            if (row_edit ) {//id为1不能编
                                //str += '<a style="margin:3px;" href="/admin/permission/' + row['id'] + '/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
                                str +='<a href="/admin/employee/'+row['id']+'/edit" class="btn btn-xs btn-outline btn-warning tooltips" data-original-title="编辑" data-placement="top"><i class="fa fa-edit"></i></a>';
                            }
