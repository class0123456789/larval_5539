    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form method="post" action="/admin/employee/autostore" class="form-horizontal">
            {{csrf_field()}}
            ...
            <div class="form-group{{ $errors->has('institution_id') ? ' has-error' : '' }}">
              ...
              <div class="form-group{{ $errors->has('file_url') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-10">
                      <input type="text" class="form-control" name="file_url" value="{{old('file_url')}}" readonly placeholder="请选择上传文件" required>
              ...
              <div class="form-group">
                  <label class="col-sm-2 control-label">文件带机构号</label>
                  <div class="col-sm-10">
                      <input type="checkbox" class="form-control" name="has_institution"  >
                  </div>

              </div>
              <div class="form-group">
                  <label class="col-sm-2 control-label">文件首行带标题列</label>
                  <div class="col-sm-10">
            ...
            <div class="form-group">
              <div class="col-sm-4 col-sm-offset-2">
                  ...
                  @endif
                  @if(haspermission('admin/employee/autostore'))
...
<script type="text/javascript">
    ...
    Dropzone.options.dropzoneForm = {
        ...
        acceptedFiles: ".pdf,.xlsx,.xls", //上传的类型
        dictInvalidFileType: "文件类型只能是*.pdf,*.xlsx,*.xls。",
        dictCancelUpload: "取消",
        init: function () {
