                    ...
                    columnDefs: [
                        {
                            ...
                            //var row_show = {{haspermission('kind.show')? 1 : 0}};    
                            var row_edit = {{haspermission('kind.edit')? 1 : 0}};
                            var row_delete = {{haspermission('kind.destroy') ? 1 :0}};
                            var str = '';
                            ...
                            if (row_edit && row['id']!=1) {//id为1不能编
                                //str += '<a style="margin:3px;" href="/admin/permission/' + row['id'] + '/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
                                str +='<a href="/admin/kind/'+row['id']+'/edit" class="btn btn-xs btn-outline btn-warning tooltips" data-original-title="编辑" data-placement="top"><i class="fa fa-edit"></i></a>';
                            }
