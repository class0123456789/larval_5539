  ...
  <div class="col-lg-10">
    ...
    <ol class="breadcrumb">
        ...
        <li>
            ...
            <a href="{{url('admin/kind')}}">机构类型列表</a>
            @endif
        </li>
        <li class="active">
            <strong>增加机构类型</strong>
        </li>
    </ol>
  </div>
</div>
        ...
        <div class="ibox-content">
          <form method="post" action="{{url('admin/kind')}}" class="form-horizontal">
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              <label class="col-sm-2 control-label">机构类型名称</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="name" value="{{old('name')}}" placeholder="机构类型名称"> 
                @if ($errors->has('name'))
