        ...
        <div class="ibox-content">
          <form method="post" action="{{url('admin/role/'.$role->id)}}" class="form-horizontal">
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="name" value="{{old('name',$role->name)}}" placeholder="角色名称"> 
                @if ($errors->has('name'))
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="description" value="{{old('description',$role->description)}}" placeholder="角色描述">
              </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
