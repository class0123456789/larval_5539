...
<div class="row wrapper border-bottom white-bg page-heading">
  ...
  <div class="col-lg-2">
    <div class="title-action">
      ...
      <a href="{{url('admin/role/create')}}" class="btn btn-info">增加角色</a>
      @endif
    </div>
  </div>
                    ...
                    columnDefs: [
                        {
                            ...
                            var row_show = {{haspermission('role.show')? 1 : 0}};    
                            var row_edit = {{haspermission('role.edit')? 1 : 0}};
                            var row_delete = {{haspermission('role.destroy') ? 1 :0}};
                            var str = '';
