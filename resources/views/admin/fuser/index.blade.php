  ...
  <div class="col-lg-7">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            ...
            <a href="/admin/fuser"><strong>前台用户列表</strong></a>
            @endif
        </li>
    </ol>
  </div>
...
// });  
     ...
     // "orderCellsTop": true,
      "dom" : '<"html5buttons"B>lTfgtip',
                    "buttons": [
        {extend: 'copy',title: '前台用户表',exportOptions:{
            columns:[0,2,3,4,5],//选择打印列
        }},
        {extend: 'csv',title: '前台用户表',exportOptions:{
            columns:[0,2,3,4,5],//选择打印列
        }},
        {extend: 'excel', title: '前台用户表',exportOptions:{
            columns:[0,2,3,4,5],//选择打印列
        }},
        //{extend: 'pdf', title: 'permission'},
        {extend: 'print',title:'前台用户表',exportOptions:{
            columns:[0,2,3,4,5],//选择打印列
        }}
        ],
                    "columns": [
                    ...
                    columnDefs: [
                        {
                            ...
                            var row_show = {{haspermission('fuser.show')? 1 : 0}};    
                            var row_edit = {{haspermission('fuser.edit')? 1 : 0}};
                            var row_delete = {{haspermission('fuser.destroy') ? 1 :0}};
                            var str = '';
                            ...
                            if (row_show) {
                                ...
                                str +='<a href="/admin/fuser/'+row['id']+'" class="btn btn-xs btn-info tooltips"  data-original-title="查看" data-placement="top"><i class="fa fa-eye"></i></a>';
                            }
                            ...
                            if (row_edit) {
                                //if(row['id']!=1){
                                //str += '<a style="margin:3px;" href="/admin/permission/' + row['id'] + '/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
                                str +='<a href="/admin/fuser/'+row['id']+'/edit" class="btn btn-xs btn-outline btn-warning tooltips" data-original-title="编辑" data-placement="top"><i class="fa fa-edit"></i></a>';
                                //}else{
                                //   str +=''; 
                                //}
