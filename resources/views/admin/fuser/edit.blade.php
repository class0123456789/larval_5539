    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form method="post" action="{{url('admin/fuser',$user->id)}}" class="form-horizontal">
            {{csrf_field()}}
            {{method_field('PUT')}}
            ...
            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                ...
                <span class="help-block text-warning m-b-none">密码为空则不更改</span>
            ...
            <div class="form-group{{ $errors->has('institution_id') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                  <select name="institution_id" class="form-control" id="institution">
                      {!!$fuserPresenter->topInstitutionList($institutions,$user->employee->institution->id) !!}
                  </select>
            ...
            <div class="form-group{{ $errors->has('employee_id') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                  <select name="employee_id" class="form-control">
                       {!!$fuserPresenter->topEmployeeList($employees,$user->employee->id) !!}
                  </select>
