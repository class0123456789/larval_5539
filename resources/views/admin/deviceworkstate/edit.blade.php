    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form method="post" action="{{url('admin/deviceworkstate/'.$deviceworkstate->id)}}" class="form-horizontal">
            {{csrf_field()}}
            {{method_field('PUT')}}
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="name" value="{{old('name',$deviceworkstate->name)}}" placeholder="设备工作状态名称"> 
                @if ($errors->has('name'))
            ...
            <div class="form-group">
              <div class="col-sm-4 col-sm-offset-2">
                  ...
                  @endif
                  @if(haspermission('deviceworkstate.update'))
