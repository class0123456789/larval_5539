...
class EquipmentUseRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        if (request()->isMethod('POST')) {
            $rules['name'] = 'required|unique:device_equipment_use,name|max:50';
            ...
            $rules['name'] = [
                ...
                'unique:device_equipment_use,name,'.$this->route('equipment')->id,//排除当前ID
