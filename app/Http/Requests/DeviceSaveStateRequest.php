...
class DeviceSaveStateRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        if (request()->isMethod('POST')) {
            $rules['name'] = 'required|unique:device_save_state,name|max:8';
            ...
            $rules['name'] = [
                ...
                'unique:device_save_state,name,'.$this->route('devicesavestate'),//排除当前ID
