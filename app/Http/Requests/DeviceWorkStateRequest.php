...
class DeviceWorkStateRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        if (request()->isMethod('POST')) {
            $rules['name'] = 'required|unique:device_work_state,name|max:8';
            ...
            $rules['name'] = [
                ...
                'unique:device_work_state,name,'.$this->route('deviceworkstate'),//排除当前ID
